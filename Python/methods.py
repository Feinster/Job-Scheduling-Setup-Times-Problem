...
def branch_and_bound(n, m, setup_costs, B, J):
    ...
    while stack:
        ...
        nodes_added += 2  # Two child nodes were added
    ...
    return job_sequence, best_objective_value, nodes_added
...
def run_job_sequencing(instance_size, output_file):
    ...
    with open(output_file, 'w') as file:
        if model.solution:
            ...
            start_time = time.time()
            bb_best_solution, bb_best_obj_value, bb_nodes_explored = branch_and_bound(n, m, setup_costs, B, J)
            end_time = time.time() - start_time
            ...
            file.write("Nodes explored with my B&B: {}\n".format(bb_nodes_explored)) 
